...
3. **Test It Works**: Run your own reference solution against the running API to confirm the challenge is solvable before participants arrive. Reference solutions are kept outside this repository (organizer-only, not shared with participants) — see the "Reference Solutions" note below.

### Reference Solutions

Working solutions (JavaScript, Python, and Java) are kept locally and are **not** part of this repository. This is deliberate: it keeps them from leaking to participants who might get read access, and it means a fresh clone of this repo never hands out the answer. Keep your own copies wherever suits your workflow.
...
1. **Test the API** with your local reference solution to verify everything works
...
1. **Show the solution code** (your local reference implementation)
